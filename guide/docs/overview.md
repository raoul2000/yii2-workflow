...
new organization. First of all, let's imagine what could be a list of statuses for our posts :
...
the work is going to be organized**, how users of our publishing system will interact with each other. For this example we will imagine the following rules :
